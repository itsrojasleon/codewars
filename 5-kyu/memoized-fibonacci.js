...
/*
  ...
  recalculates all the Fibonacci numbers already calculated by the 
  ...
  take a nap while you wait for the answer. But if you try it here in Code Wars 
...
const fibonacci = memoization(slowFibonacci);
