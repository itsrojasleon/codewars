...
/*
  ...
  either "true"/"True" or "false"/"False" (check the sample tests
  about what capitalization to use in a given language).
  ...
  variable. In this example, the input to boolean_to_string 
